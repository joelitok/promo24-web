    ...
    <div class="gallery-section popup-gallery">
        <div class="container">
            ...
            <div class="owl-carousel owl-theme text-center" data-toggle="owl" data-owl-options="{
                ...
                <a href="{{asset('frontend/images/about/gallery1.jpg')}}" class="gallery-item">
                    <img src="{{asset('frontend/images/about/gallery1.jpg')}}" alt="gallery image">
                </a>
                <a href="{{asset('frontend/images/about/gallery2.jpg')}}" class="gallery-item">
                    <img src="{{asset('frontend/images/about/gallery2.jpg')}}" alt="gallery image">
                </a>
                <a href="{{asset('frontend/images/about/gallery3.jpg')}}" class="gallery-item">
                    <img src="{{asset('frontend/images/about/gallery3.jpg')}}" alt="gallery image">
                </a>
                <a href="{{asset('frontend/images/about/gallery4.jpg')}}" class="gallery-item">
                    <img src="{{asset('frontend/images/about/gallery4.jpg')}}" alt="gallery image">
                </a>
            </div>
    ...
    <div class="company-section">
        <div class="container">
            <div class="row align-items-lg-center">
                <div class="col-md-6">
                    <img src="{{asset('frontend/images/about/img-1.jpg')}}" alt="image">
                </div><!-- End .col-lg-6 -->
