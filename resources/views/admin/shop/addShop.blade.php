                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-8">
                        <input class="form-control" maxlength="50" name="shop_name" type="text" placeholder="Nom de la boutique..">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                          <input class="form-control" maxlength="1000" name="shop_description" type="text" placeholder="Description de la boutique..">
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-lg-3">
