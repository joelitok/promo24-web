                ...
                <div class="footer-middle">
                    <div class="row row-sm">
                        <div class="col-lg-6 col-xl-4">
                            <a href="index.html">
                                <img src="{{asset('frontend/images/logo-black.png')}}" alt="Porto Logo">
                            </a>
                            <div class="row row-sm">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="contact-widget">
                                        <h4 class="widget-title">TELEPHONE</h4>
                                        <a href="#">+237 676 471 717</a>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="contact-widget">
                                        <h4 class="widget-title">TRAVAIL JOURS/HEURS</h4>
                                        <a href="#">TOUS LES JOURS 24H/24 7J/7</a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="widget">
                                ...
                                <ul class="links link-parts">
                                    <div class="link-part">
                                        ...
                                        <li><a href="#">Methode de Payement</a></li>
                                        <li><a href="#">FAQs</a></li>
                        ...
                        <div class="col-md-4 col-lg-2 col-xl-3">
                            <div class="widget">
                                ...
                                <ul class="links">
                                    ...
                                    <li><a href="#">Notre groupe</a></li>
                                </ul>
                            </div><!-- End .widget -->
                        </div>
                        <div class="col-md-4 col-lg-2 col-xl-2">
                            <div class="widget">
                                <h4 class="widget-title">Partenaire</h4>
                                <ul class="links">
